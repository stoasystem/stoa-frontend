    ...
    with get_connection() as connection:
        ...
        connection.execute(
            ...
            (
                ...
                conversation_id,
                "assistant",
                "This is a demo AI response. In the real system, this answer will be generated by the backend AI service.",
                "completed",
                created_at,
            ),
        )
...
def child_monthly_report(child_id: str, user: dict[str, str] = Depends(require_role("parent"))) -> dict[str, object]:
    ...
    return {
        **weekly,
        ...
        "summary": (
            "Monthly report placeholder: Anna is building stronger habits across math, physics, and writing. "
            "The real backend will generate a fuller monthly trend once production analytics are available."
        ),
        "isPlaceholder": True,
    }
