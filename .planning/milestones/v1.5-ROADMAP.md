...
<details open>
<summary>✅ v1.5 Phase 6 Authentication, User Roles, and Parent Visibility (Phases 21-27) - IMPLEMENTED 2026-05-24</summary>
...
- [x] **Phase 21: Authentication Contracts, Store, and Route Guards** - Add role/user types, auth API client, token persistence, auth hooks, 401/403 handling, protected routes, role routes, and login/register/error pages.
- [x] **Phase 22: SQLite-Backed Local Test Backend** - Add a local FastAPI + SQLite backend with auth, schema, seed data, permission filtering, and Phase 6 API contracts.
- [x] **Phase 23: Student Profile, History, and Chat Scoping** - Add student profile/history services, hooks, pages, and current-user chat scoping.
- [x] **Phase 24: Parent Dashboard and Child Visibility** - Add parent children, child summary, child history services/hooks/pages/components with parent-child permission boundaries.
- [x] **Phase 25: Tutor Help Request Workflow** - Add tutor help-request list/detail/status services, hooks, pages, and status controls.
- [x] **Phase 26: Role-Aware App Layout and Navigation** - Add role-aware layout navigation, user menu, role badge, admin placeholder, and consistent authenticated app shell.
- [x] **Phase 27: Phase 6 Documentation and Verification** - Document Phase 6 auth, roles, local SQLite backend, seed accounts, and verify build plus role/API flows.
...
| 21. Authentication Contracts, Store, and Route Guards | v1.5 | 1/1 | Complete | 2026-05-24 |
| 22. SQLite-Backed Local Test Backend | v1.5 | 1/1 | Complete | 2026-05-24 |
| 23. Student Profile, History, and Chat Scoping | v1.5 | 1/1 | Complete | 2026-05-24 |
| 24. Parent Dashboard and Child Visibility | v1.5 | 1/1 | Complete | 2026-05-24 |
| 25. Tutor Help Request Workflow | v1.5 | 1/1 | Complete | 2026-05-24 |
| 26. Role-Aware App Layout and Navigation | v1.5 | 1/1 | Complete | 2026-05-24 |
| 27. Phase 6 Documentation and Verification | v1.5 | 1/1 | Complete | 2026-05-24 |
