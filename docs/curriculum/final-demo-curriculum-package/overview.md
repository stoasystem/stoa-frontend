# Final Demo Curriculum Package Overview
...
5. If the student still needs help, `Explain this step` opens Learning Chat with the practice context.
6. Learning Assistant explains the current step in a guided way.
...
- Hints can guide without giving away the answer.
- Parents can understand what the child is practising.
- Tutors can quickly see where support is needed.
- The same topic can demonstrate Practice, Learning Chat, teacher support, and Parent Report value.
...
3. Linear systems in two variables

## Connected Product Surfaces

Practice Path is the proactive learning entry. It gives the student short, structured practice.

Learning Chat is the guided explanation entry. It helps when the student is stuck on a specific step.

Professional teacher support is the escalation path. It appears only after the student has tried feedback, hints, and guided explanation.

Parent Report is the visibility layer. It explains what the student practised, where help was requested, and what the next useful step is.
