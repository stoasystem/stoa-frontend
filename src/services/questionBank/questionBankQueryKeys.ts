// Same reasoning as practiceQueryKeys: these responses carry curriculum titles
// in the reader's language, and the language is deliberately absent from the
// keys — a switch invalidates them all and refetches behind the content already
// on screen.
