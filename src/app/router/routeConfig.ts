...
export const navItems: AppNavItem[] = [
  ...
  },
  {
    ...
    icon: 'practice',
    mobile: true,
    description: 'Short guided lessons that can open Learning Chat when a step is unclear.',
  },
  {
    label: 'Learning Chat',
    path: '/chat',
    ...
    icon: 'chat',
    mobile: true,
    description: 'Ask questions, explain unclear steps, and request teacher help.',
  },
  {
...
export const routeMetadata: AppRouteMeta[] = [
  ...
  { path: '/chat', pageName: 'ChatPage', role: 'student', module: 'Learning', status: 'core', priority: 'P0', navPriority: 'primary', purpose: 'Student Learning Chat explanation and teacher-help request flow.' },
