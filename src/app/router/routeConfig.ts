...
export const routeMetadata: AppRouteMeta[] = [
  ...
  { path: '/forgot-password', pageName: 'ForgotPasswordPage', role: 'public', module: 'Auth', status: 'core', priority: 'P1', navPriority: 'hidden', purpose: 'Password reset request by email.' },
  { path: '/reset-password', pageName: 'ResetPasswordPage', role: 'public', module: 'Auth', status: 'core', priority: 'P1', navPriority: 'hidden', purpose: 'Password reset code confirmation and new password.' },
