...
import { ScholarshipProgramPage } from '@/pages/scholarship/ScholarshipProgramPage'
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/stipendienprogramm" element={<ScholarshipProgramPage />} />
        <Route path="/scholarship-program" element={<ScholarshipProgramPage />} />
